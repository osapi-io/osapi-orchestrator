...
<a name="HostStatusOk"></a>Host\-level status constants returned by the API for per\-host results. These represent agent\-side outcomes, distinct from task\-level statuses \(TaskStatusChanged, TaskStatusSkipped, etc.\) which are DAG\-level.
...
## type [Orchestrator](<https://github.com/osapi-io/osapi-orchestrator/blob/main/pkg/orchestrator/types.go#L35-L41>)
...
<a name="Result"></a>
## type [Result](<https://github.com/osapi-io/osapi-orchestrator/blob/main/pkg/orchestrator/types.go#L27>)
...
<a name="TaskResult"></a>
## type [TaskResult](<https://github.com/osapi-io/osapi-orchestrator/blob/main/pkg/orchestrator/types.go#L31>)
